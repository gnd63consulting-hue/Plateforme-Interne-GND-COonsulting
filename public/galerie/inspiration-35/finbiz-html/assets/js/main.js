(function ($) {
  ...
  var imJs = {
    ...
    swiperActivation: function () {
      ...
      $(document).ready(function () {
        var swiper = new Swiper(".testi-slide-active", {
          slidesPerView: 4,
          spaceBetween: 30,
          loop: true,
          speed: 1000,
   ...
   menuActive: function () {
    ...
    // Close sidebar via close icon or overlay
    $(document).on("click", ".close-icon-menu, #anywhere-home", function () {
        $("#side-bar").removeClass("show");
        $("#anywhere-home").removeClass("bgshow");
    });

    // Toggle dropdown submenu without closing sidebar
    $(document).on("click", ".mainmenu .has-droupdown > a", function(e){
        e.preventDefault(); // Prevent default navigation
        $(this).siblings(".submenu").slideToggle(300);
        $(this).toggleClass("open");
    });

    // Close sidebar on regular link clicks
    $(document).on("click", ".mainmenu li a:not(.has-droupdown > a)", function () {
        $("#side-bar").removeClass("show");
        $("#anywhere-home").removeClass("bgshow");
    });
  },
