    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <Target className="h-3.5 w-3.5 text-gnd-bronze-faded" aria-hidden />
            </div>
            <p className="mt-4 font-display text-3xl font-medium leading-none text-gnd-bronze-soft">
          ...
          >
            ...
            <div className="relative flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Briefcase className="h-3.5 w-3.5 text-gnd-amber" aria-hidden />
            ...
            <div className="mt-6 flex items-baseline gap-1">
              ...
              <span className="font-display text-xl text-gnd-amber">/</span>
              <span className="font-display text-2xl text-gnd-cream/60">
                tot.
              </span>
            </div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <div className="rounded-xl bg-gnd-cream/5 p-3">
                <p className="font-mono text-[8px] uppercase tracking-[0.15em] text-gnd-cream/50">
                  Contactés
                </p>
                <p className="mt-0.5 font-display text-xl font-medium text-gnd-cream">
                  {contacted}
                </p>
              </div>
              <div className="rounded-xl bg-gnd-amber/15 p-3">
                <p className="font-mono text-[8px] uppercase tracking-[0.15em] text-gnd-amber">
                  Signés
                </p>
                <p className="mt-0.5 font-display text-xl font-medium text-gnd-amber">
                  {signed}
                </p>
              </div>
            </div>
        ...
        >
          ...
          >
            <div className="flex items-center justify-between">
              <span className="font-mono text-[9px] font-semibold uppercase tracking-[0.18em] text-gnd-amber-dim">
                Conversion
              </span>
              <TrendingUp className="h-3.5 w-3.5 text-gnd-amber" aria-hidden />
            </div>
            <p className="mt-3 font-display text-3xl font-medium italic leading-none text-gnd-amber">
